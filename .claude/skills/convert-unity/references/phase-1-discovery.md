...
**Escape hatch:** If nothing looks like a gameplay scene, read `ProjectSettings/EditorBuildSettings.asset` — it lists the scenes Unity considers part of the build.
...
**Escape hatch:** Run discovery with `--verbose` to inspect the full error list before deciding.

...
| `phase-5-assembly.md` | 5 | Terrain, LFS, MCP painting |
| `phase-6-upload.md` | 6 | Two-stage upload, Studio publish |
| `upload-patching.md` | 6 (detail) | Asset ID patching internals |
